...
class TopCat extends React.Component {
    ...
    addIframe = () => {
        let thisApp = document.getElementById(this.state.name)
        thisApp.querySelector('.app-content').innerHTML = `<iframe src='https://dev.maydenacademy.co.uk/projects/2019Jul/2019-top-cat/'></iframe>`
    }
    ...
    render() {
        ...
        return (
            <div onClick={this.activateApp} id={this.state.name} className={'app ' + this.state.visibility}
                ...
                <iframe title="TopCat" src='https://dev.maydenacademy.co.uk/projects/2019Jul/2019-top-cat/'></iframe>
                </div>
